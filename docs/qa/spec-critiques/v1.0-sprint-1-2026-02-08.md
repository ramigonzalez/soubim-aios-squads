...
|----|----|----------|-------|-----------------|
| 1.1.1 | Specification | Minor | "All indexes created and optimized" is vague - doesn't specify index types (BTREE, HASH, etc.) | Document actual index types in acceptance criteria or migration file comments |
