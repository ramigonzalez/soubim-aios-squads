...
- [x] AC1: Seed data includes items of all 5 types (idea, topic, decision, action_item, information) across multiple sources
- [x] AC2: At least 3 items marked as milestones in seed data (1 decision, 1 action_item, 1 information)
- [x] AC3: All seed items use affected_disciplines[] arrays (not single discipline field)
- [x] AC4: Decision items include structured V2 impacts and consensus JSON
- [x] AC5: Seed data includes ProjectParticipant records for at least 2 projects
- [x] AC6: Seed data includes Source records (meeting, email, document, manual_input types)
- [x] AC7: All existing backend tests updated to use ProjectItem model and new field names
- [x] AC8: All existing frontend tests updated to handle item_type and affected_disciplines[]
- [x] AC9: New test cases cover: item type filtering, milestone toggle, is_done toggle
- [x] AC10: `npm run frontend:test` and `npm run frontend:lint` pass
- [x] AC11: Backend tests pass (`pytest` in decision-log-backend/)
...
- [x] 1.1 Create Source records in seed.py (0.5h)
...
- [x] 1.2 Create ProjectParticipant records (0.5h)
...
- [x] 1.3 Create ProjectItem seed data (2h)
...
- [x] 1.4 Create StageSchedule seed data for E6 (0.5h)
  - 3-4 stage records for project 1
  - Include stage names, start/end dates, milestone references

- [x] 1.5 Verify seed.py runs without errors (0.5h)
...
- [x] 2.1 Update existing model tests (0.5h)
...
- [x] 2.2 Update existing API route tests (1h)
...
- [x] 3.1 Update component tests using item data (1h)
...
- [x] 3.2 Add new test cases for V2 features (0.5h)
...
- [x] 3.3 Run test suite and fix failures (0.5h)
...
### Modified Files
- `decision-log-backend/app/database/seed.py` — Add V2 seed data (Sources: email, document, manual_input; StageSchedule; done action items)
- `decision-log-frontend/src/tests/components/ProjectCard.test.tsx` — Updated for V2 (items vs decisions, StagePill, project_type)
- `decision-log-frontend/src/tests/pages/Projects.test.tsx` — Updated empty state assertion
- `decision-log-frontend/src/tests/components/StagePill.test.tsx` — New tests for StagePill component
